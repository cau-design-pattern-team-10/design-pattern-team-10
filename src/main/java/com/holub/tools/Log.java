 ...
 * console window with the normal timestamp header stripped of. You can accomplish a similar thing
 * by modifying the <i>$JAVA_HOME/jre/lib/logging.properties</i> file, setting the
 * <code>.level</code> and
 * <code>java.util.logging.ConsoleHandler.level</code>
 * properties to <code>ALL</code>. This change causes all messages to go to the console, but the
 * timestamp header will appear, too.
 * <p>Here's an example:
 * <pre>
